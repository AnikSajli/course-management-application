    ...
    public class TeacherController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddTeacher([FromBody] Teacher query)
        {
            try
            {
                ...
                Teacher teacherByEmail = await this.repository.GetTeacherByEmail(teacher.Email);
                if (teacherByEmail != null)
                {
                    return BadRequest("Email Taken");
                }
                Teacher teacherByPhone = await this.repository.GetTeacherByPhone(teacher.PhoneNumber);
